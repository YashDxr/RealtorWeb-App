    ...
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col w-full">
        ...
        <p className="m-4 text-slate-700">
          Welcome to <span className="text-indigo-700">RealtorWeb</span>, your
      ...
      <p className="m-4 text-slate-700">
        At <span className="text-indigo-700">RealtorWeb</span>, we are
      ...
      <p className="m-4 text-slate-700">
        Our mission at <span className="text-indigo-700">RealtorWeb</span> is to
      ...
      <p className="m-4 text-slate-700">
        ...
        <span className="text-indigo-700">RealtorWeb</span> as your trusted real
